...
/**
 * 呼叫 Google Gemini API 分析字幕
 */
async function analyzeSubtitlesWithGemini(srtContent) {
  console.log('🤖 正在呼叫 Google Gemini API 分析字幕...\n');
...
async function main() {
  try {
    console.log('🎬 開始測試 Google Gemini 字幕分析功能\n');
    ...
    // 分析字幕
    const analysisResult = await analyzeSubtitlesWithGemini(subtitle.srt_content);
