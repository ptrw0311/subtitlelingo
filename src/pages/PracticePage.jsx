...
function PracticePage() {
  ...
  const currentQuestion = fakeQuestions[currentQuestionIndex];
  const progress = ((currentQuestionIndex + 1) / fakeQuestions.length) * 100;
            ...
            <div className="max-w-2xl mx-auto">
              <div className="card text-center">
                ...
                <div className="text-6xl font-bold mb-4">
                  ...
                  <span className="text-slate-400">/{fakeQuestions.length}</span>
                </div>
                <p className="text-xl text-slate-300 mb-8">
                  正確率：{Math.round((score / fakeQuestions.length) * 100)}%
                </p>
          ...
          <div className="mb-6">
            <div className="bg-slate-800/50 rounded-lg p-4">
              ...
              <div className="text-2xl font-bold text-amber-400 mb-2">
                {currentQuestionIndex + 1} / {fakeQuestions.length}
              </div>
              ...
              <div className="flex justify-between">
                ...
                {!showResult ? (
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200"
                  >
                    {currentQuestionIndex < fakeQuestions.length - 1 ? '下一題' : '查看結果'}
                  </button>
                )}
              </div>
            </div>
